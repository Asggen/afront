...
const jsDirectory = path.join(__dirname, "build-prod-static/static/js");
...
module.exports = {
  ...
  plugins: [
    new BannerWebpackPlugin({
      chunks: {
        main: {
          afterContent: `setTimeout(console.log.bind(console,"%cStop!",'color:red;font-size:3rem;font-famaily:-apple-system;font-weight:bold;'),0);`,
        },
      },
    }),
  ],
